...
export class Networks {
    ...
    registerAll(): { networks: NetworksUserConfig, etherscan: Etherscan } {
        ...
        this.registerCustom('arc', 5042, process.env.ARC_RPC_URL, process.env.ARC_PRIVATE_KEY || privateKey, etherscanApiKey, 'https://api.etherscan.io/v2/api?chainid=5042', 'https://explorer.arc.io/api', 'osaka');
