...
contract('UniERC20', function (accounts) {
    describe('ERC20 token', async function () {
        ...
        it('uni transfer', async function () {
            ...
            expect(await this.wrapper.balanceOf(account1)).to.be.bignumber.equal(toBN(100));
        });
        ...
        it('uni transfer from', async function () {
            ...
            expect(await this.wrapper.balanceOf(account2)).to.be.bignumber.equal(toBN(100));
        });
    ...
    describe('ETH', async function () {
        ...
        it('uni transfer, insufficient balance', async function () {
            await expect(this.wrapper.transfer(account1, 100, { value: 99 })).to.be.rejectedWith('InsufficientBalance');
        });
